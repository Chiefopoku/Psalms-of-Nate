...
export function PageHeader({ title, description }: Readonly<{ title: string; description?: string }>) {
  return (
    <section className="border-b border-white/70 bg-white/35">
      <Container className="py-12 sm:py-16">
        <p className="mb-4 text-xs font-bold uppercase tracking-[0.18em] text-[hsl(var(--primary))]">Psalms of Nate</p>
